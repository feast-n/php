...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr style="background-color: <?= ($p['umur'] >= 30) ? '#ffcccc' : 'transparent'; ?>;">
                <td><?= $index + 1; ?></td>
                <td><?= $p['nama']; ?></td>
                <td><?= $p['umur']; ?></td>
                <td><?= $p['tinggi']; ?></td>
                <td>
                    <?= 
                    match ($p['kelas']) {
                        'A' => "Kelas Desain Grafis Madya",
                        'B' => "Kelas Junior Web Developer",
                        'C' => "Kelas Cyber Security",
                        'D' => "Kelas Bahasa Inggris",
                        'E' => "Kelas Jaringan Komputer", 
                        default => "Tidak ada kelas",
                    }; 
                    ?>
                </td>
                <td>
                    <?= ($p['umur'] >= 17) ? 'Sudah memiliki KTP' : 'Belum memiliki KTP'; ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
